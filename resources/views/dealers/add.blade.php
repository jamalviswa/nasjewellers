                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Add Dealer Details</h4>
                        </div>
                        <div class="card-body p-4">
                            <div class="row">
                                <div class="offset-lg-3 col-lg-6">
                                    <div class="mt-4 mt-lg-0">
                                        <form id="basic-form" action="{{ route('dealers.store') }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class=" mb-3">
                                                <label class="form-label">Jewels Type<span class="text-danger"> *</span></label>
                                                <div>
                                                    <div class="form-check-inline">
                                                        <input class="form-check-input" id="formRadios1" type="radio" checked {!! (old('jewels_type')=="Gold" ) ? "checked" : "" !!} name="jewels_type" value="Gold">
                                                        <label class="form-check-label" for="formRadios1">Gold</label>
                                                    </div>
                                                    <div class="form-check-inline">
                                                        <input class="form-check-input" id="formRadios2" type="radio" name="jewels_type" {!! (old('jewels_type')=="Silver" ) ? "checked" : "" !!} value="Silver">
                                                        <label class="form-check-label" for="formRadios2">Silver</label><br />
                                                    </div>
                                                    <div class="form-check-inline">
                                                        <input class="form-check-input" id="formRadios3" type="radio" name="jewels_type" {!! (old('jewels_type')=="All" ) ? "checked" : "" !!} value="All">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control text-capitalize" maxlength="100" autocomplete="off" name="dealer_name" value="{{old('dealer_name')}}">
