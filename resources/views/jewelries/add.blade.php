                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Add Gold Jewelries Details</h4>
                        </div>
                        <div class="card-body p-4">
                            <div class="row">
                                <div class="offset-lg-3 col-lg-6">
                                    <div class="mt-4 mt-lg-0">
                                        <form id="basic-form" action="{{ route('jewelries.store') }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select" name="item_name">
                                                        ...
                                                        ?>
                                                            <option @if((old('item_name')) && old('item_name')==$item['id']) selected @endif value="<?php echo $item->id ?>"><?php echo $item->item_name ?></option>
                                                        <?php }
                                                        ?>
                                                    </select>
                                                    @error('item_name')
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select qualitytype" name="quality_type">
                                                        ...
                                                        <option {{ old('quality_type')=="Halmark"?"selected":"" }} value="Halmark">Halmark</option>
                                                        <option {{ old('quality_type')=="HUID"?"selected":"" }} value="HUID">HUID</option>
                                                    </select>
                                                    @error('quality_type')
                                                    <div class="text text-danger">{{ $message }}</div>
                                                    @enderror
                                            ...
                                            <div class="row justify-content-end">
                                                <div class="col-sm-9">
                                                    <div>
                                                        ...
                                                        <a href="{{ route('items.index') }}" class="btn btn-danger w-md">Cancel</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
