                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Edit Silver Billing Details</h4>
                        </div>
                        <div class="card-body p-4">
                            <div class="row">
                                <div class="offset-lg-3 col-lg-6">
                                    <div class="mt-4 mt-lg-0">
                                        <form id="basic-form" action="{{ route('billings.update',$billing['id']) }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row mb-4">
                                                <label class="col-sm-3 col-form-label">Customer Name<span class="text-danger"> *</span></label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control text-capitalize" maxlength="100" autocomplete="off" name="customer_name" value="{{$billing['customer_name']}}">
                                                    @error('customer_name')
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" autocomplete="off" name="mobile_number" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="10" minlength="10" value="{{$billing['mobile_number']}}">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control text-capitalize" rows="5" name="address">{{$billing['address']}}</textarea>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="datepicker-basic" autocomplete="off" name="date" value="{{$billing['date']}}">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" autocomplete="off" name="weight" value="{{$billing['weight']}}">
